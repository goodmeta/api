...
import {RaffleBuyer, RaffleBuyerRelations, User, RaffleCampaign} from '../models';
...
> {
  ...
  public readonly raffleCampaign: BelongsToAccessor<RaffleCampaign, typeof RaffleBuyer.prototype.id>;
